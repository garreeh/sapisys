      ...
      <div class="modal-body">
        <form method="post" enctype="multipart/form-data">
          <div class="form-group col-md-12">
            <h3>Do you want to Tag as Ongoing?</h3>
          ...
          <input type="hidden" name="tag_as_approved" value="1">
...
<script>
  $(document).ready(function() {
    $('#approveAppointmentModal form').submit(function(event) {
      ...
      $.ajax({
        type: 'POST',
        url: '/appointment/controllers/admin/tag_as_approved_process.php',
        data: formData,
