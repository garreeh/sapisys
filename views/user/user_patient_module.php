            ...
            <div class="mb-4">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="prescription" role="tabpanel" aria-labelledby="prescription-tab">
                  <br>
                  <?php include '../user_patient_navigation/prescription_solo.php' ?>
                </div>
                <div class="tab-pane fade" id="vaccination" role="tabpanel" aria-labelledby="vaccination-tab">
                  <br>
                  <?php include '../user_patient_navigation/vaccination_solo.php' ?>
                </div>
                <div class="tab-pane fade" id="files" role="tabpanel" aria-labelledby="files-tab">
                  <br>
                  <?php include '../user_patient_navigation/filesupload_solo.php' ?>
                </div>
