            ...
            <div class="col-xl-12 col-lg-12">
              <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                ...
                <div class="table-responsive">
                  ...
                  <table class="table custom-table table-hover" name="user_billing_table" id="user_billing_table">
                    <thead>
                      <tr>
                        <th>Billing ID</th>
                        <th>Client Name</th>
...
<script>
  $('#sidebarToggle').click(function() {
    $('#user_billing_table').css('width', '100%');
    // console.log(table) //This is for testing only
  });

  //Table for Supplier
  $(document).ready(function() {
    var user_billing_table = $('#user_billing_table').DataTable({
      "pagingType": "numbers",
      "processing": true,
      "serverSide": true,
      "ajax": "./../../controllers/tables/user_billing_table.php",
    });

    window.reloadDataTable = function() {
      user_billing_table.ajax.reload();
    };
  ...
  $(document).ready(function() {
    ...
    $('#user_billing_table').on('click', 'tr td:nth-child(6) .fetchDataCategory', function() {
